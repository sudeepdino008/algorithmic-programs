...
void heapify(h *heap,long long heap structure, we can store the data in an array such that the children of the node at position i are at position 2i and 2i+1.

int B);                                          //heapifying the given min heap
